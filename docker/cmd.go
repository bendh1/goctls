...
func init() {
	...
	dockerCmdFlags.StringVarPWithDefaultValue(&varStringBase, "base", "a", "alpine:3.19")
	...
	dockerCmdFlags.StringVarPWithDefaultValue(&varStringImage, "image", "i", "golang:1.20.8-alpine3.17")
